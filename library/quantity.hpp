...
// the distinction between quantities of different things.
//
// https://www.github.com/wovo/one
// 
...
namespace one_concepts {
   
// concept for the copy constructor
...
// concept for the  assignment operator
template< typename V, typename W >
